...
def inserts():
    ...
    {'titulo': 'TORBJORN', 'descricao': 'Torbjörn Lindholm é um engenheiro sueco brilhante e um dos membros fundadores da Overwatch. Conhecido por sua paixão por construir e por sua personalidade um tanto explosiva, Torbjörn desempenhou um papel crucial na criação de muitas das tecnologias avançadas que a Overwatch utilizava.', 'link': 'https://overwatch.fandom.com/wiki/Torbjorn', 'tags': 'Engenheiro Suécia Construção Overwatch2', 'classe': 'DPS'},
    ...
    try:
        while True:
            ...
            # Verifica se encontrou resultados
                ...
                nova_pesquisa = input('Deseja pesquisar outro personagem? (SIM | NÃO)\n')
                if nova_pesquisa.upper() == 'SIM':
                    limpar_terminal()
                    pass
